...
These dimensions operationalize classic implementation conditions: clear objectives (Mazmanian and Sabatier), fiscal capacity (Grindle), legal authority, accountability constraints (Lipsky), and coordination (Hjern).
...
These dimensions synthesize the convergence documented by @jobin2019 around transparency, fairness, accountability, and privacy—distinguishing aspirational statements from concrete requirements with measurable standards.
...
The **capacity-ethics gap** (0.83 vs. 0.61) indicates governments more frequently specify institutional structures than operationalize ethical principles. This receives detailed examination in @sec-pca-nexus.
