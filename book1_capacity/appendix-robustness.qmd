...
### Model Diagnostics and Score Distributions
...
**Multilevel model specifications.** The multilevel models reported in @sec-cap-multilevel were estimated using restricted maximum likelihood (REML) with the `lme4` package in R. We report full variance decomposition and model comparison statistics.
